...
_FILENAME_TO_ID = {'Rear_view_user_id_20931_NoAudio_5': 1, 'Rear_view_user_id_20931_NoAudio_7': 2, 'Rear_view_user_id_41850_NoAudio_5': 3, 'Rear_view_user_id_41850_NoAudio_7': 4, 'Rear_view_user_id_61962_NoAudio_5': 5,
                   'Rear_view_user_id_61962_NoAudio_7': 6, 'Rear_view_user_id_86433_NoAudio_5': 7, 'Rear_view_user_id_86433_NoAudio_7': 8, 'Rear_view_user_id_96269_NoAudio_5': 9, 'Rear_view_user_id_96269_NoAudio_7': 10,
                   'Dashboard_user_id_20931_NoAudio_5': 1, 'Dashboard_user_id_20931_NoAudio_7': 2, 'Dashboard_user_id_41850_NoAudio_5': 3, 'Dashboard_user_id_41850_NoAudio_7': 4, 'Dashboard_user_id_61962_NoAudio_5': 5,
                   'Dashboard_user_id_61962_NoAudio_7': 6, 'Dashboard_user_id_86433_NoAudio_5': 7, 'Dashboard_user_id_86433_NoAudio_7': 8, 'Dashboard_user_id_96269_NoAudio_5': 9, 'Dashboard_user_id_96269_NoAudio_7': 10,
                   'Right_side_window_user_id_20931_NoAudio_5': 1, 'Right_side_window_user_id_20931_NoAudio_7': 2, 'Right_side_window_user_id_41850_NoAudio_5': 3, 'Right_side_window_user_id_41850_NoAudio_7': 4,
                   'Right_side_window_user_id_61962_NoAudio_5': 5, 'Right_side_window_user_id_61962_NoAudio_7': 6, 'Right_side_window_user_id_86433_NoAudio_5': 7, 'Right_side_window_user_id_86433_NoAudio_7': 8,
                   'Right_side_window_user_id_96269_NoAudio_5': 9, 'Right_side_window_user_id_96269_NoAudio_7': 10}
...
def load_k_fold_probs(pickle_dir, view):
    probs = []
    with open(os.path.join(pickle_dir, "A2_{}_vmae_16x4_crop_fold1.pkl".format(view)), "rb") as fp:
...
def main():
    clip_classification = []
    pickle_dir_videomae = "pickles_videomae_fold1/A2"
    ...
    pickle_dir_uniformer_full = "pickles_uniformer_fold1/A2"
    ...
    pickle_dir_x3d = "pickles_X3D_fold1/A2"
    ...
    with open("pred_ensemble_fold1.txt", "w") as fp:
        for (vid, label, start, end) in loc_segments:
            fp.writelines("{} {} {} {}\n".format(int(vid), label, start, end))
    df = pd.read_csv('pred_ensemble_fold1.txt', delimiter=' ', names=["ID", "Label (Primary)", "Start Time", "End Time"])
    df = df.sort_values(by=['ID', 'Start Time'])
    df.to_csv('pred_ensemble_fold1.txt', index=False, header=False, sep=' ')
