    ...
    for cur_iter, (inputs, labels, _, meta) in enumerate(train_loader):
        ...
        if cfg.DETECTION.ENABLE:
            ...
            if cfg.DATA.MULTI_LABEL:
                ...
                # Compute the errors.
                num_topks_correct = metrics.topks_correct(preds, labels, (1, 5)) # change to (1, 3) if num_cls <= 5
                top1_err, top5_err = [
    ...
    for cur_iter, (inputs, labels, _, meta) in enumerate(val_loader):
        ...
        if cfg.DETECTION.ENABLE:
            ...
            if cfg.DATA.MULTI_LABEL:
                ...
                # Compute the errors.
                num_topks_correct = metrics.topks_correct(preds, labels, (1, 5)) # change to top-3 if num_cls <= 5
