...
df1.to_csv("A1_clip/train_right_1.csv", index=False, header=False, sep=' ')

df2 = pd.DataFrame()
df2['dir'] = list_pd_dirs_rear_view
df2['dir'] = 'data/' + df2['dir']
df2['label'] = list_pd_labels_rear_view
df2.to_csv("A1_clip/train_rear_1.csv", index=False, header=False, sep=' ')

df3 = pd.DataFrame()
df3['dir'] = list_pd_dirs_dashboard
df3['dir'] = 'data/' + df3['dir']
df3['label'] = list_pd_labels_dashboard 
df3.to_csv("A1_clip/train_dash_1.csv", index=False, header=False, sep=' ')
