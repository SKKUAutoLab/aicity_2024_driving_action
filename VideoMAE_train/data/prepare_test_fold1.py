...
list_train = ["user_id_96269", "user_id_20931", "user_id_61962", "user_id_41850", "user_id_86433"]
list_dirs = []
list_clips = []
list_train.sort()
...
df1.to_csv("A1_clip/test_right_1.csv", index=False, header=False, sep=' ')

df2 = pd.DataFrame()
df2['dir'] = list_pd_dirs_rear_view
df2['dir'] = 'data/' + df2['dir']
df2['label'] = list_pd_labels_rear_view
df2.to_csv("A1_clip/test_rear_1.csv", index=False, header=False, sep=' ')

df3 = pd.DataFrame()
df3['dir'] = list_pd_dirs_dashboard
df3['dir'] = 'data/' + df3['dir']
df3['label'] = list_pd_labels_dashboard 
df3.to_csv("A1_clip/test_dash_1.csv", index=False, header=False, sep=' ')
