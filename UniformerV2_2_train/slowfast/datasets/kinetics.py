...
class Kinetics(torch.utils.data.Dataset):
    ...
    def _construct_loader(self):
        ...
        """
        # path_to_file = os.path.join(self.cfg.DATA.PATH_TO_DATA_DIR, "{}_{}_{}.csv".format(self.mode, self.cfg.view, self.cfg.user_id))
        path_to_file = os.path.join(self.cfg.DATA.PATH_TO_DATA_DIR, "{}_{}_{}.csv".format(self.mode, self.cfg.view, self.cfg.fold))
